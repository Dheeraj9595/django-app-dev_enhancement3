...
def customize_qr_code(
    ...
    eye_shape,
    product_id,
    qr_code_logo_img_name=None,
    img_name=None,
    qr_code_logo_img=None,
    bgColor=None,
):
    product = None
    try:
        ...
        if qr_code_logo_img:
            qr_logo_upload_success, qr_logo_filename = upload_qr_code_logo_img(
                qr_code_logo_img
            )
        ...
        if response.status_code == 200:
            ...
            if product.gs1_link:
                ...
                img_name = (
                    f"{product.product_name}_{product.short_id}_{int(time.time())}.png"
                )
