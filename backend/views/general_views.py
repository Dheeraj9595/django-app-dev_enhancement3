...
def reporting_view(request):
    ...
    QR Reporting View
    """
    required_groups = ["Super Admin", "Campaign User", "Client Admin User"]  #groups accessible to reporting view
...
def planning_view(request):
    ...
    Planning View
    """
    required_groups = ["Super Admin", "Campaign User", "Client Admin User"]  # Define required groups here
...
def qr_manage_view(request):
    ...
    QR Manage View
    """
    required_groups = ["Super Admin", "Client Admin User", "Campaign User"]  # Define required groups here
...
def qr_code_templates_view(request):
    ...
    if request.method == "POST":
        qr_code_template = product_models.QRCodeCutomizationTemplates.objects.create(
            ...
            qr_code_background_color=request.POST.get(
                "qr_code_template_background_color"
            ),
        ...
        return render(
            request,
            "qr_code_templates.html",
            {"products": products, "qr_code_templates": qr_code_templates},
        )
