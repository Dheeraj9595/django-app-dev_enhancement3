...
from .constants import CODE_TYPE_CHOICES, CODE_PLACEMENT_CHOICES


class GoogleAnalytics(models.Model):
    product = models.ForeignKey(
        Product, on_delete=models.CASCADE, db_column="product_name"
    )
    ...
    campaign = models.ForeignKey(
        Campaign, on_delete=models.CASCADE, db_column="campaign_name", null=True
    )
